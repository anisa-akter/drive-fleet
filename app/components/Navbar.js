    ...
    <header className="sticky top-0 z-40 border-b border-black/10 bg-[#f7f3ee]/90 backdrop-blur">
      <Container className="flex items-center justify-between py-4">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            <p className="section-title text-lg font-semibold text-black">
              DriveFleet
            </p>
        ...
        <nav className="hidden items-center gap-6 text-sm font-medium text-black/70 lg:flex">
          ...
          <Link href="/add-car" className="hover:text-black">
            Add Car
          </Link>
          <Link href="/my-bookings" className="hover:text-black">
            My Bookings
          </Link>
          {!user ? (
        ...
        <div className="flex items-center gap-3">
          <div className="dropdown dropdown-end lg:hidden">
            <label
              tabIndex={0}
              className="btn btn-outline-drive btn-sm rounded-full"
            >
              Menu
            </label>
            <ul
              tabIndex={0}
              className="menu dropdown-content mt-3 w-48 rounded-box bg-white p-2 shadow"
            >
              <li>
                <Link href="/">Home</Link>
              </li>
          ...
          {loading ? (
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="menu dropdown-content mt-3 w-52 rounded-box bg-white p-2 shadow"
              >
                <li>
                  <Link href="/add-car">Add Car</Link>
                </li>
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/login"
                className="btn btn-drive btn-sm rounded-full px-2"
              >
                Login
              </Link>
            </div>
